...
@php
    $klasifikasiOptions = config('archive.klasifikasi', []);
    $indeksOptions = config('archive.indeks', []);
    $kVal = old('klasifikasi', $letter?->klasifikasi);
...
<div class="sm:col-span-2">
    ...
    >
        <option value="" disabled @selected($kVal === null || $kVal === '')>Pilih klasifikasi</option>
