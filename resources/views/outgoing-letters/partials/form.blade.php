...
>
    ...
    <div class="grid gap-6 sm:grid-cols-2">
        ...
        <div>
            ...
            <x-text-input id="tanggal_surat" name="tanggal_surat" type="date" class="mt-1 block w-full dark:bg-slate-900 dark:border-slate-700 dark:text-white" :value="old('tanggal_surat', $outgoingLetter?->tanggal_surat?->format('Y-m-d'))" required />
